...
async def get_income_by_source_and_month(source: str, year: int, month: int):
    incomes = income_service.get_income_by_source_and_month(source, year, month)
    return incomes


@router.get("/and_year/", response_model=List[Income])
async def get_income_by_source_and_year(source: str, year: int):
    incomes = income_service.get_income_by_source_and_year(source, year)
    return incomes
...
async def get_income_by_source_and_month_range(
    ...
    incomes = income_service.get_income_by_source_and_month_range(
